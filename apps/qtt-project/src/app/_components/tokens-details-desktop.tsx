...
export default function TokensDetailsDesktop({
  data,
  session,
}: {
  data: Data | null;
  ...
  return (
    <div className="relative hidden lg:grid">
      <div className=" grid w-full grid-cols-2 gap-x-10 ">
        <div className=" grid grid-cols-2 gap-3 ">
          ...
          <div className="col-start-2 flex flex-col justify-between gap-y-2 rounded-xl border border-white border-white/30 bg-[#818181]/[0.08] p-3 transition-all duration-300 hover:bg-[#0400D6]/[0.17]">
      ...
      <div className="flex w-full flex-row gap-x-10">
        <div className=" top-20 -z-10 -mt-28">
          <Image
            src={"/coins-anim.gif"}
            alt=""
            width={600}
        ...
        <div className=" mt-16 grid h-fit w-full max-w-[30rem] grid-cols-2 gap-3">
          <div className="flex flex-col justify-between gap-y-2 rounded-xl border border-white border-white/30 bg-[#818181]/[0.08] p-3 transition-all duration-300 hover:bg-[#0400D6]/[0.17]">
          ...
          <div className="col-start-1 row-start-2 flex flex-col justify-between gap-y-2 rounded-xl border border-white border-white/30 bg-[#818181]/[0.08] p-3 transition-all duration-300 hover:bg-[#0400D6]/[0.17]">
            <h1 className=" font-sm">
              Reserve Fund{" "}
              <EditModal
                session={session}
          ...
          <div className="col-start-2 row-start-2 flex flex-col justify-between gap-y-2 rounded-xl border border-white border-white/30 bg-[#818181]/[0.08] p-3 transition-all duration-300 hover:bg-[#0400D6]/[0.17]">
            <h1 className=" font-sm">
              Advisors & Partners{" "}
              <EditModal
                session={session}
